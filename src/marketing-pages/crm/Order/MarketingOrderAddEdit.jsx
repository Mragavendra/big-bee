...
const MarketingOrderAddEdit = () => {
  const navigate = useNavigate();
  
  const [formData, setFormData] = useState({
    orderId: 'LED045', // Dummy data
    orderDate: '15-09-2025', // Dummy data
    orderValue: '50000', // Dummy data
    quotationId: 'QUO123', // Dummy data
    quotationDate: '10-09-2025', // Dummy data
    prospect: 'ABC Corp', // Dummy data
    contactPerson: 'John Doe', // Dummy data
    emailId: 'john.doe@abccorp.com', // Dummy data
    mobileNumber: '9876543210', // Dummy data
    department: 'Sales', // Dummy data
    designation: 'Manager', // Dummy data
    addressLine1: '123 Business Park', // Dummy data
    landmark: 'Near City Mall', // Dummy data
    street: 'Main Street', // Dummy data
    state: 'karnataka', // Dummy data
    city: 'bangalore', // Dummy data
    pincode: '560001', // Dummy data
    baseAmount: '45000', // Dummy data
    gstPercent: '18', // Dummy data
    gstTaxValue: '8100', // Dummy data
    discount: '2000', // Dummy data
    finalTotal: '50900', // Dummy data
    eventDate: '25-09-2025', // Dummy data
    eventLocation: 'Convention Center', // Dummy data
    service: 'Event Management', // Dummy data
    bde: 'Ravi Kumar', // Dummy data
    clientServicingPerson: 'Priya Sharma', // Dummy data
    activeStatus: true // Dummy data
  });
...
export default MarketingOrderAddEdit;
...
const EditOrder = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Replace the console.log with your PUT API call to update the order
    console.log('Edited Form Data:', formData);
    // Example:
    // axios.put(`/api/orders/${formData.orderId}`, formData).then(...).catch(...)
  };
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">GST / Tax Value</label>
                    <input
                      type="text"
                      name="gstValue"

...
import { TrendingUp, TrendingDown, Users, Eye, MousePointer, DollarSign, ShoppingCart, Target, Calendar, Filter } from 'lucide-react';
...
const MarketingDashboard = () => {
  ...
  const campaignPerformance = [
    { name: 'Summer Sale', clicks: 1250, impressions: 45000, ctr: 2.8, cost: 890 },
    { name: 'Product Launch', clicks: 980, impressions: 38000, ctr: 2.6, cost: 750 },
    { name: 'Brand Awareness', clicks: 2100, impressions: 95000, ctr: 2.2, cost: 1200 },
    { name: 'Retargeting', clicks: 650, impressions: 22000, ctr: 3.0, cost: 420 },
  ];
  ...
  const miniTrend = [
    { value: 20 }, { value: 35 }, { value: 28 }, { value: 45 }, { value: 52 }, { value: 48 }, { value: 65 }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
          <div>
            ...
            <p className="text-gray-600">Track your marketing performance and campaign metrics</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={websiteTrafficData}>
                ...
                />
                <Line type="monotone" dataKey="visitors" stroke="#3B82F6" strokeWidth={3} dot={{ fill: '#3B82F6', strokeWidth: 2, r: 4 }} />
                <Line type="monotone" dataKey="pageViews" stroke="#10B981" strokeWidth={3} dot={{ fill: '#10B981', strokeWidth: 2, r: 4 }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-xl p-6 shadow-lg border border-gray-100">
            <h3 className="text-lg font-semibold text-gray-900 mb-6">Weekly Conversions</h3>
            <ResponsiveContainer width="100%" height={300}>
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 shadow-2xl border border-gray-700">
            <h3 className="text-lg font-semibold text-white mb-6">Top Campaigns</h3>
            <div className="space-y-4">
              {campaignPerformance.map((campaign, index) => (
                <div key={index} className="p-4 bg-gray-700/50 rounded-lg hover:bg-gray-700/70 transition-all border border-gray-600/50 hover:border-orange-500/50">
                  <div className="flex items-center justify-between mb-2">
                    <h4 className="font-medium text-white">{campaign.name}</h4>
                    <span className="text-sm font-medium text-orange-400">{campaign.ctr}% CTR</span>
                  </div>
                  <div className="grid grid-cols-2 gap-2 text-sm text-gray-300">
                    <div>
                      <span className="text-gray-400">Clicks:</span>
                      <span className="ml-1 font-medium text-white">{campaign.clicks.toLocaleString()}</span>
                    </div>
                    <div>
                      <span className="text-gray-400">Cost:</span>
                      <span className="ml-1 font-medium text-white">${campaign.cost}</span>
                    </div>
                  </div>
                  <div className="mt-2">
                    ...
                    <div className="w-full bg-gray-600 rounded-full h-1.5">
                      <div 
                        ...
                        style={{ width: `${(campaign.clicks / campaign.impressions) * 100 * 30}%` }}
                      ></div>
                    </div>
                  </div>
                </div>

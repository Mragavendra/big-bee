...
const ActionEdit = () => {
  ...
  const [funnelStatus, setFunnelStatus] = useState({
    ...
    description: 'Lead has been qualified and ready for sales engagement',
    isActive: true
  });

  const handleInputChange = (e) => {
    const { name, value } = e.target;
    setFunnelStatus(prev => ({
      ...prev,
      [name]: value
    }));
  };
    ...
    <div className="p-6">
      <div className="mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-semibold text-gray-900">Edit Funnel Status</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea 
                  name="description"
                  value={funnelStatus.description}
                  onChange={handleInputChange}
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <div className="flex items-center">
              ...
              <div 
                className={`relative inline-flex h-8 w-14 items-center rounded-full cursor-pointer transition-colors ${funnelStatus.isActive ? 'bg-orange-500' : 'bg-gray-200'}`}
                onClick={toggleActiveStatus}
              >
                <div className={`inline-block h-6 w-6 transform rounded-full bg-white transition-transform ${funnelStatus.isActive ? 'translate-x-7' : 'translate-x-1'} shadow-sm`}>
                  {funnelStatus.isActive && (

...
const FollowUpModeAdd = () => {
  ...
  const handleSave = async () => {
    if (!modeData.mode.trim()) {
      setSnackbar({ open: true, message: "Mode name is required", severity: "error" });
      return;
    }

    try {
      const response = await axios.post("http://localhost:5000/api/followup-modes/create", {
      ...
      if (response.data) {
        setSnackbar({ open: true, message: "FollowUp Mode created successfully", severity: "success" });
        setTimeout(() => navigate("/settings/follow-up-mode"), 1500);
      }
    } catch (error) {
      setSnackbar({
        open: true,
        message: error.response?.data?.message || "Failed to create FollowUp Mode",
        severity: "error",
      });
    }
  };
    ...
    <div className="p-6">
      <div className="mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-semibold text-gray-900">Add FollowUp Mode</h1>
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  placeholder="Enter Followup Mode"
...
export default FollowUpModeAdd;
